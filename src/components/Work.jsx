...
import myPanel from "../assets/mypanel.jpeg"
...
const Work = () => {
  return (
    <div name='work' className='w-full md:h-screen pt-8'>
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full proyect'>
        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
          ...
          <div
            style={{ backgroundImage: `url(${myPanel})` }}
            className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'
          >
            <div className='opacity-0 group-hover:opacity-100'>
              <span className='text-2xl font-bold text-white tracking-wider'>
              ...
              <div className='pt-8 text-center'>
                <a href='https://myuserpanel.vercel.app/' target="_blank">
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Demo
                  </button>
                </a>
                <a href='https://github.com/RominaOlivera/agrak-react-challenge' target="_blank">
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Code
                  </button>
                </a>
            ...
            <div
            style={{ backgroundImage: `url(${FastDeliveryApp})` }}
            className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'
          >
            <div className='opacity-0 group-hover:opacity-100'>
              <span className='text-2xl font-bold text-white tracking-wider'>
              ...
              <div className='pt-8 text-center'>
                ...
                <a href='https://github.com/RominaOlivera/fastDeliveryApp' target="_blank">
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Code
                  </button>
                </a>
